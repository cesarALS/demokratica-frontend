                    ...
                    <div className= "flex flex-col h-full w-full justify-start p-2 gap-2">
                        ...
                        <div className = "flex flex-col sm:flex-row justify-between">
                            <form className = "w-full sm:w-[45%]">
                                ...
                                <CustomInput labelString="Confirma contraseña:" inputType="password" inputId="confirmed_password" initialValue='Tu contraseña'></CustomInput>
                            ...
                            <div className = "w-full sm:w-[45%] flex flex-col justify-start pt-6 pb-2 gap-y-4 sm:py-10 sm:gap-y-6">
                                ...
                                <div className = "flex flex-row justify-between gap-x-10 px-10 sm:px-0 sm:gap-x-4">
                                    ...
                                    <Link href = "/" className = "p-2 rounded-lg bg-SecGray w-full hover:text-AccentBlue">
                                        <FontAwesomeIcon icon={faFacebook} />
                                    </Link>
                                </div>
                                <h2 className = "text-sm"> 
                                    ¿Ya tienes cuenta? 
                                    <Link href = {demokraticaRoutes.login.link} className = "text-blue-500 underline"> Inicia sesión </Link>
                                </h2>
                            </div>
                        </div>
...
const CustomInput = ({labelString, inputType, inputId, initialValue} : CustomInputProps) => {
    return (
        <div>
            ...
            <input className = "bg-SecGray p-1 text-SecBlack text-[0.8em] gap-2 w-full" type={inputType} id={inputId} name={inputId} placeholder={initialValue} /> <br></br>
        </div>
    );
}
